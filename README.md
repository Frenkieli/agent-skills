...
- [code-goal-writer](skills/code-goal-writer/SKILL.md): Write complete, measurable coding Goal contracts with intent, scope, acceptance results, validation loops, and stop conditions.
